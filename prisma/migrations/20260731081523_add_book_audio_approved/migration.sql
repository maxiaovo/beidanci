...
CREATE TABLE "new_Book" (
    ...
    "audioApproved" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_Book" ("analyzeDone", "analyzeTotal", "audioDone", "audioTotal", "createdAt", "id", "name", "ownerId", "rawUnits", "sharedWithAll", "status") SELECT "analyzeDone", "analyzeTotal", "audioDone", "audioTotal", "createdAt", "id", "name", "ownerId", "rawUnits", "sharedWithAll", "status" FROM "Book";
DROP TABLE "Book";
